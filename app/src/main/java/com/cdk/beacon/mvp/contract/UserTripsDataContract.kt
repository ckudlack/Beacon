...
interface UserTripsDataContract {
    ...
    interface Repository : BaseRepository {
        ...
        fun addTrip(trip: BeaconTrip): Observable<List<BeaconTrip>>
        ...
        fun setBeaconFrequency(tripId: String, frequency: Int): Observable<BeaconTrip>
        fun deleteTrip(tripId: String) : Observable<Boolean>
    }
}